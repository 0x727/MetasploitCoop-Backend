"""
Django settings for homados project.
...
SECRET_KEY = 'sa8nv3b6)biz+!v8)5n_z#_la@303gtng(w6f6tzg#04oul^g$'
...
WSGI_APPLICATION = 'homados.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'homados.contrib.pagination.PageSizePagination',
    'PAGE_SIZE': 20,
...
# LOGGING_DIR the dir log files are stored
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            'level': 'DEBUG',
            'filters': ['require_debug_true'], # the log is printed on the screen only if Django Debug is True
